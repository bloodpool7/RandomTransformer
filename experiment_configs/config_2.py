...
def get_config(basepath):
    ...
    config= {
        # wd
        'wd': os.path.join(basepath, 'experiments', 'test_2_size_1024_4'),
        # Raw data
...
def run_augmentation(basepath, queues):
    ...
    # add augmentation
    auged_data.extend(aug_scripts.aug_block(queues, queues_percent=85, visualize=True))
