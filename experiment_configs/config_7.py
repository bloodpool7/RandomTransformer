...
def get_config(basepath):
    ...
    config= {
        # wd
        'wd': os.path.join(basepath, 'experiments', 'test_7_size_1024_t3_1'),
        # Raw data
        ...
        'extra_nist_params': ['--nonoverpar', '3'],
...
def run_augmentation(basepath, queues):
    ...
    auged_data.extend(aug_scripts.aug_aperiodic_templates(queues, template_path, queues_percent=100, nr_inserted_templates_min=25, nr_inserted_templates_max=150))
